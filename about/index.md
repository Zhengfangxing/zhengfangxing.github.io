...
My name is DongXu Zheng. I am currently a senior software engineer in HSBC, China. I major in Java back end. 

With more understanding of software enginne, I found the theory used to describe a phenomenon is more and more elegant but in the same time complicated. I was happy about the Microservice, impressed by distributed system, struck by cluster technology and now mesmerized by python and go. **I am aware that software requires much more than *just* java. In the same time I believe that with more programming language there will be deeper software enginne.**

As for my current interest, on my CV I wrote:

> I am interested in the internet technology. In a different perspective, I am also interested in how to Establish Cloud Ecosystem . I also like coding and enjoy sharing my thoughts.

Here is my [CV](https://zhengfangxing.github.io/about/CV-of-Zheng-Dongxu.pdf) (last update: 2019-03-16).
...
The best way to reach me is via email: $boyisxuxu$ @ $gmail.com$